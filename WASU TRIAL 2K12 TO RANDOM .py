...
webbrowser.open('''https://t.me/T3AMN0VA''')
import os, requests
import sys
import time
import webbrowser
from datetime import datetime
EXPIRE_TIME = '2025-05-13 17:00:00'
EXPIRE_MSG = '  WASU NE FILE STOP KARDI USKE PAAS SE RENEW KARWAAO @WASUpy'
...
a = print(f"""
{red}
{red} {red}-> {white}CHOICE IS YOUR Want To Hunt For {red}-> {red} 
{red}
{red} {red}-> {red}1{red} - {red}2012                             {red}    
{red} {red}-> {red}2{red} - {red}2013                             {red}    
{red} {red}-> {red}3{red} - {red}2011 {white}~ {red}2023                  {red}        """)
ShridharX = input(f"{red}-> {white}CHOISE IS  YOUR : {reset}")
...
𝗙𝗢𝗟𝗟𝗢𝗪𝗘𝗥: ﴾ {follower_count} ﴿
𝗙𝗢𝗟𝗟𝗢𝗪𝗜𝗡𝗚 : ﴾ {following_count} ﴿   
𝗗𝗔𝗧𝗘   : {calc_date}    
𝗥𝗘𝗦𝗘𝗧 :  {reset_email}
𝗟𝗜𝗡𝗞 : https://www.instagram.com/{username}
𝗗𝗘𝗩 @WASUpy BY @YUNOpy
▬▭▬▭▬▭▬▭▬▭▬▭▬
'''

    with open('wasu2k12.txt', 'a') as ff:
        ff.write(f'{ss}\n')
